const forma = document.querySelector('.right-steps__form');
//для кнопки наверх
...
if ($('.box-currencys-for-inputs_crypto').length){	
	...
	$('.left-currency-input_crypto').click(function(){
		...
		console.log(window.getComputedStyle(secret).display)
		// let check = $('.box-currencys-for-inputs_crypto').getAttribute('display');
		if ((window.getComputedStyle(secret).display) === 'none'){
			...
			$(this).parent('.inputs-currency').parent('.box-currency-inputs').children('.box-currencys-for-inputs').slideUp(300);
	...
	$('.left-currency-input_cash').click(function(){
		const secret2 = document.getElementById('secret_box2');
		const arrow2 = document.getElementById('arrow2')
		if ((window.getComputedStyle(secret2).display) === 'none'){
			secret2.style.display = 'flex'
			$(this).parent('.inputs-currency').parent('.box-currency-inputs').children('.box-currencys-for-inputs').slideDown(300);
			$(this).addClass('active-left-currency-input');
	...
	// $('.active-left-currency-input_x').click(remove_menu);

...
if ($('.box-currencys-for-inputs_crypto').length){	
	...
	// 	$('.box-currencys-for-inputs').slideUp(300);
	// }
	function click_post_currency_crypto_x(){
		$('.left-currency-input').removeClass('active-left-currency-input');
		$('.box-currencys-for-inputs').slideUp(300);
	}
	function click_post_currency_crypto(){
		...
		$exchange_crypto2 = $('.' + $code_currency_crypto + '_exchanges').children('.RUB').html();
		$exchange_crypto3 = $('.' + $code_currency_crypto + '_exchanges').children('.EUR').html();
		$exchange_crypto4 = $('.' + $code_currency_crypto + '_exchanges').children('.USD').html();
		$('.current_informer').html($exchange_crypto);
		$('.current_informer2').html($exchange_crypto2);
		$('.current_informer3').html($exchange_crypto3);
		$('.current_informer4').html($exchange_crypto4);
	...
	$('.box-currencys-for-inputs_cash').children('.post-currency-for-input').first().addClass('activer_cash_currentcy'); 
		...
		$exchange_crypto4 = $('.' + $code_currency_crypto + '_exchanges').children('.USD').html();
		$('.current_informer').html($exchange_crypto);
		$('.current_informer2').html($exchange_crypto);
		$('.current_informer3').html($exchange_crypto3);
		$('.current_informer4').html($exchange_crypto4);
	...
	// $('.active-left-currency-input').click(click_post_currency_crypto_x)
	$('.post-currency-for-input_crypto').click(click_post_currency_crypto);
	$('.post-currency-for-input_cash').click(open_window_exchange);
